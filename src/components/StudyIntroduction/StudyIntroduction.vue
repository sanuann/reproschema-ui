      ...
      <div class="container">
        <div class="screen" v-show="step === 1">
          <div class="panel">
            ...
            <p>mPower research study was developed by Sage Bionetworks (non-profit) to measure the
              symptoms, day to day changes, and long-term changes in people with Parkinson’s
              Disease (PD).</p>
          </div>
        </div>
        ...
        <div class="screen" v-show="step === 3">
          <div class="panel">
            ...
            <p>We will ask you to participate for 2 weeks every three months. We would like you to
              participate for 2 years, but you can participate as long as you like.</p>
          </div>
        </div>
        <div class="screen" v-show="step === 4">
          <div class="panel">
            ...
            <p>You may not directly benefit from taking part but seeing trends in your data may be
              interesting to you. You may help researchers better understand PD.</p>

            <p>The main risk is to your privacy by an accidental release of your data. You may find
              some of the activities tiring and seeing your data may be stressful.</p>
          </div>
        </div>
      </div>
    </section>
