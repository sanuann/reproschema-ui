    ...
    <section class="smooth-scroller" style="padding-top: 0">
      ...
      <section>
        <div class="container">
          ...
          <p>We understand that living with Parkinson’s Disease (PD) can be unsettling due to the
            uncertain nature of the disease.  Unlike many other conditions, symptoms and the way
            they change over time are different for each person. Due to the irregular and unique
            progression of PD, you don’t always know when your symptoms will evolve and how disease
            will impact your life over time. </p>
        </div>
      </section>
      ...
      <section>
        <div class="image container">
          ...
          <div class="text">
            ...
            <p>In just a minute you can see if you are eligible to participate in the mPower study.
              Find out now!</p>
